...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="fade-in max-w-4xl mx-auto my-20 px-6 pb-20">
      <h2 className="text-4xl font-bold mb-12 text-center text-white dark:text-white light:text-gray-900 bg-gradient-to-r from-white/70 via-white to-white/70 dark:from-white/70 dark:via-white dark:to-white/70 light:from-gray-700 light:via-gray-900 light:to-gray-700 bg-clip-text">
        Get In Touch
      </h2>
      <div className="contact-form-wrapper glass bg-opacity-10 backdrop-blur-sm p-8 md:p-10 rounded-2xl border border-white/10 hover:border-white/20 transition-all shadow-lg">
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="text-2xl font-semibold text-white dark:text-white light:text-gray-900 mb-2">Message Sent Successfully!</h3>
            <p className="text-white/70 dark:text-white/70 light:text-gray-600">Thank you for reaching out. I'll get back to you soon.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="form-group">
                <label htmlFor="name" className="text-white/90 dark:text-white/90 light:text-gray-700 text-lg mb-2 block font-medium">Name</label>
                <Input
                  id="name"
                  value={formData.name}
              ...
              <div className="form-group">
                <label htmlFor="email" className="text-white/90 dark:text-white/90 light:text-gray-700 text-lg mb-2 block font-medium">Email</label>
                <Input
                  id="email"
            ...
            <div className="form-group">
              <label htmlFor="subject" className="text-white/90 dark:text-white/90 light:text-gray-700 text-lg mb-2 block font-medium">Subject</label>
              <Input
                id="subject"
            ...
            <div className="form-group">
              <label htmlFor="message" className="text-white/90 dark:text-white/90 light:text-gray-700 text-lg mb-2 block font-medium">Message</label>
              <Textarea
                id="message"
